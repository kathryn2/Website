...
head(offenders)
```
![](/post/2017-11-25-last-words-from-death-row_files/offenders.png)
...
![](/post/2017-11-25-last-words-from-death-row_files/tdm.png)
...
```
![](/post/2017-11-25-last-words-from-death-row_files/word_cloud.png)
...
barplot(d[1:15,]$freq, las = 2, names.arg = d[1:15,]$word,
        ...
        ylab = "Frequency")
```
![](/post/2017-11-25-last-words-from-death-row_files/barchart.png)
