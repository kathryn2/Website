...
First load the dataset, which contains state names, census regions, census divisions, 2013 populations and the number of registered gun owners (also in 2013).  This data comes to us from <a href="http://www.cbsnews.com/pictures/most-heavily-armed-states-in-america/">CBS News</a>.
...
```
<img src="/post/2016-12-17-how-heavily-armed-is-your-state_files/Firearms_Data_KAD.png">
...
boxplot
```
<img src="/post/2016-12-17-how-heavily-armed-is-your-state_files/Rplot.png">
...
![](/post/2016-12-17-how-heavily-armed-is-your-state_files/WSJ.png)
...
![](/post/2016-12-17-how-heavily-armed-is-your-state_files/Regions.png)
...
![](/post/2016-12-17-how-heavily-armed-is-your-state_files/state_bars.png)
...
![](/post/2016-12-17-how-heavily-armed-is-your-state_files/map1.png)
...
![](/post/2016-12-17-how-heavily-armed-is-your-state_files/regional.png)
